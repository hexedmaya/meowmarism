...
(() => {
  ...
  const DICT = {
    de: {
      ...
      'Backup now': 'Jetzt sichern', 'Backup settings': 'Backup-Einstellungen', 'World backups': 'Welt-Backups', 'Keep at most': 'Höchstens behalten', 'Every': 'Alle', 'Keep': 'Mindestens', 'GB free': 'GB frei', 'How often backups run automatically, how many are kept, and how much disk space must stay free after a backup.': 'Wie oft Backups automatisch laufen, wie viele behalten werden und wie viel Speicherplatz nach einem Backup frei bleiben muss.', 'Every (hours)': 'Alle (Stunden)', 'After': 'Nach', 'Full': 'Voll',
